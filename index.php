...
<body>
    ...
    <header>
        <nav>
            <div>
                    <a href="#" class="nav-item nav-logo">G O</a>
    ...
    <section id="home">
        <div id="route-search-form">
            <h1>Go Travels Ticket Booking</h1>

            <p class="text-center">Welcome to Go Travels Ticket Booking. Login now to manage bus tickets and much more. OR, simply scroll down to check the Ticket status using Passenger Name Record (PNR number)</p>
            ...
            <br>
            <center>
            <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#signinModal">Customer Login</button>
            </center>
    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                ...
                <p>
                The customer himself is a very important developer. And those pleasures that are freed from suffering, never open the door to the truth. With the desire to benefit the customer himself, let him pursue the adipiscing of the developer. Let's accuse him when he doesn't have that option because he blames him and he is held! The company itself is a very successful company. But let the pleasures of the body be pleasing to those in the manner of certain pleasures, greater ones to follow him.
                </p>
            </div>
        </section>
        <section id="contact">
        ...
        <footer>
        <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - Go Travels Ticket Booking | Made with &#10084;&#65039; by Jaysurya & Shalom
                        </p>
        </footer>
    </div>
